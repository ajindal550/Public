...
| Your integration goal | Endpoints you use |
| --- | --- |
| Basic catalog & inventory sync (e.g. Shopify, BigCommerce) | [Products](products.md), [Variants](variants.md), [Images](images.md), [Inventory Levels](inventory.md), [Collections](collections.md), [Collects](collects.md), [Locations](locations.md) |
| Full commerce sync (adds order capture & customers) | Above **+** [Customers](customers.md), [Orders](orders.md), [Transactions](transactions.md) |
| **Retail Advisor** — feed POS data into the AI advisor | Above **+** [Purchase Orders](purchase-orders.md) **+** [Orders](orders.md) tagged as SO |
